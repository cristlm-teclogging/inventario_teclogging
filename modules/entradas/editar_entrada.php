                ...
                <form action="./modificar_entrada.php" method="POST" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-4 mt-3">
                            ...
                            <input type="number" class="form-control" name="id_entrada" id="id_entrada" value="<?php echo $row['id_entrada']?>">
                        </div>
                        <div class="col-4 mt-3">
                        ...
                        <div class="col-4 mt-3">
                            ...
                            <input type="number" class="form-control" name="dias_trabajados" id="dias_trabajados" value="<?php echo $row['dias_trabajados']?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-4 mt-3">
                            <label for="documentos_firmados" class="form-label">Docuemntos firmados:</label>
                            <input type="file" class="form-control" name="documentos_firmados" id="docuemntos_firmados"value="<?php echo $row['documentos_firmados']?>">
                        </div>
                    </div>
