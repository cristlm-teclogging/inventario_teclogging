...
$sql_sensores = $conexion->prepare("INSERT INTO `item`(`id_tipo_item`, `descripcion`, `marca`, `modelo`, `rango`, `output`, `certificado`, `fecha_calibracion`, `url_cert`, `estado_item`, `status`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$sql_sensores->bind_param("sssssssssss",  $id_tipo_item, $descripcion, $marca, $modelo, $rango, $output, $certificado, $fecha_calibracion, $url_cert, $estado_item, $status);
