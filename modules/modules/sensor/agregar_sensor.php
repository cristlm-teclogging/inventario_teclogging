...
$sql = "INSERT INTO `sensores`(`num_serie`,`id_item`, `rango`, `output`, `cert_enyca`, `fecha_calibracion`, `url_enyca`, `status`)VALUES('$num_serie', '$id_item','$rango','$output','$cert_enyca','$fecha_calibracion','$url_enyca','$status')";
