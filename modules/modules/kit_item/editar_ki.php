    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h4 class="fw-bolder">Editar kit item</h4>
            </div>
            <div class="card-body">
                <form action="modificar_ki.php" method="POST" enctype="multipart/form-data" required>
                    <div class="row">
                        <div class="col-4 mt-2">
                        <label for="id_kit" class="form-label">Numero de Kit</label>
                        <select name="id_kit" id="id_kit" class="form-select" value="<?php echo $row['num_kit']?>" required>
                        ...
                        <div class="col-4 mt-2">
                            <label for="id_item" class="form-label">Id del item</label>
                             <select name="id_item" id="id_item" class="form-select" value="<?php echo $row['id_item']?>" required>
                                <option value="" selected disabled>Selecciona tu opción</option>
                        ...
                        <div class="col-4 mt-2">
                            <label for="tipo_item" class="form-label">Tipo de Item</label>
                             <select name="tipo_item" id="tipo_item" class="form-select" value="<?php echo $row['tipo_item']?>" required>
                                <option value="" selected disabled>Selecciona tu opción</option>
