...
/*
$sql = "INSERT INTO `antena`(`id_tipo_item`,`num_antena`, `num_plato`, `marca`, `modelo`, `descripcion`,`ns_modem`, `estado_item`, `status`)VALUES('$id_tipo_item', '$num_antena', '$num_plato', '$descripcion', '$marca', '$modelo', '$ns_modem', '$estado_item', '$status')";
